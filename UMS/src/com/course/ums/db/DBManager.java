...
public class DBManager {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost/ums?useLegacyDatetimeCode=false";

    public static Connection getConnection() throws SQLException {
        return DriverManager.getConnection(DB_URL,"root","j8oOm2lJm");
    }
    ...
    public static int addUser(JSONObject request) throws SQLException, JSONException {
